...
class RecipesViewSet(viewsets.ModelViewSet):
    ...
    def _generate_upload_url(self, filename="image"):
        ...
        return {"presigned_upload_url": presigned_url, "image_upload_key": image_key}
    ...
    def create(self, request):
        ...
        request_presigned = serializer.validated_data.pop(
            "request_presigned_url", False
        )
        ...
        if request_presigned:
            ...
            try:
                ...
                response_data["presigned_url_error"] = (
                    "Failed to generate upload URL, but recipe was created successfully"
                )
